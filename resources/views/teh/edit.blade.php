...
@section('konten')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('teh.update', $teh->kodeteh) }}" method="POST" onsubmit="return validasiForm()">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="merkteh" id="merkteh" class="form-control" maxlength="30"
                            value="{{ old('merkteh', $teh->merkteh) }}" placeholder="Masukkan Merk Teh">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" name="stockteh" id="stockteh" class="form-control" min="0"
                            value="{{ old('stockteh', $teh->stockteh) }}" placeholder="Masukkan jumlah stock">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select name="tersedia" id="tersedia" class="form-select">
                            ...
                            <option value="Y" {{ old('tersedia', $teh->tersedia) == 'Y' ? 'selected' : '' }}>Ya
                            </option>
                            <option value="N" {{ old('tersedia', $teh->tersedia) == 'N' ? 'selected' : '' }}>Tidak
                            </option>
                        </select>
                    </div>
                </div>
